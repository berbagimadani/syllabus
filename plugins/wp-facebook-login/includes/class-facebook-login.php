...
class Facebook_Login {
	...
	private function load_dependencies() {
		...
		add_filter( 'registration_redirect', array( $this, 'my_redirect_register' ) );
	...
	public function my_login_redirect( $redirect_to, $request, $user ) {
		...
		global $user;
		$redirect_to = $this->opts['fb_redirect_url'];
	...
	public function my_redirect_register( $registration_redirect ) {
		return $this->opts['fb_redirect_url'];
	}
