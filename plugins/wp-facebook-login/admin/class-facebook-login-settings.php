...
class Facebook_Login_Settings {
	...
	public function __construct() {
		...
		$this->fields   = array(
			'app_id'        => 'App id',
			'fb_redirect_url'        => 'Fb Redirect Url',
	 ...
	 * Display APP id field
	 */
	public function display_fb_redirect_url() {
		// Now grab the options based on what we're looking for
		$opts = get_option( 'fbl_settings' ); 
		$fb_redirect_url = isset( $opts['fb_redirect_url'] ) ? $opts['fb_redirect_url'] : '';
		
		// And display the view
		include_once $this->views . 'settings-fb-redirect-url-field.php';
	}
